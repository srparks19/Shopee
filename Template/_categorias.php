...
<section id="special-price">
    <div class="container">
        <h4 class="font-rubik font-size-20">Accesorios en:</h4>
                        ...
                        <div class="text-center">
                            ...
                            <form method="post">
                                ...
                                if (in_array($item['item_id'], $in_cart ?? [])){
                                    ...
                                    echo '<button type="submit" name="special_price_submit" class="btn btn-warning font-size-12">Añadir al carrito</button>';
                                }
                                ?>
                            </form>
                        </div>
